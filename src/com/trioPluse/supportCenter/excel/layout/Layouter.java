package com.trioPluse.supportCenter.excel.layout;
...
public class Layouter {
 ...
 public static void buildTitle(HSSFSheet worksheet, int startRowIndex, int startColIndex) {
  ...
  cellTitle.setCellValue("Travel Report");
 ...
 public static void buildHeaders(HSSFSheet worksheet, int startRowIndex, int startColIndex) {
  ...
  headerCellStyle.setFillBackgroundColor(HSSFColor.DARK_GREEN.index);
  ...
  cell5.setCellValue("Destination");
  cell5.setCellStyle(headerCellStyle);
  
  HSSFCell cell6 = rowHeader.createCell(startColIndex+5);
  cell6.setCellValue("Staying Period");
  cell6.setCellStyle(headerCellStyle);
  
  HSSFCell cell7 = rowHeader.createCell(startColIndex+6);
  cell7.setCellValue("Flight Cost");
